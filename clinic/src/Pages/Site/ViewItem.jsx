                    ...
                    <div className='view-item-details rounded-2 p-3 bg-light text-light gap-3'>
                        <div className='d-flex flex-column gap-3 w-100'>
                            ...
                            <div className='d-flex flex-column item-qty'>
                                ...
                                {itemData.qty === 0 ? <pre className="text-danger text-dark fst-italic m-0">*Out of Stock</pre> : <pre className='text-dark'>Stocks: {itemData.qty - item.qty}</pre>}
                            </div>
                        ...
                        <div className='d-flex gap-3 w-100'>
                            <button type='submit' style={{fontSize: '12px'}} className={`w-100 btn ${isOutOfStock ? 'btn-outline-secondary disabled' : 'btn-outline-success'} py-2 px-3 text-uppercase `}>Add to Cart <IconPark path={'iconoir:add-to-cart'} size={18} /></button>
                            <button type='button' onClick={handlePreOrder} style={{fontSize: '12px'}} className={`w-100 btn ${!isPreOrderEnabled ? 'btn-outline-secondary disabled' : 'btn-outline-success'} py-2 px-3 text-uppercase `}>Pre-Order <IconPark path={'ph:basket-bold'} size={18} /></button>
                        </div>
                    </div>
                </form>
